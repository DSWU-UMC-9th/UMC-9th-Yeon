...
/**
 * 서버 명세(스크린샷)에 맞춘 LP 조회:
 * - query: cursor, limit, search, order(asc|desc)
 * - response: { status, statusCode, message, data: { items: Lp[], nextCursor, hasNext } }
 * 다양한 백엔드 포맷을 허용하도록 널가드/정규화 처리 포함.
 */
